train:
	python3 train.py --workers 1 --batch-size 4 --data data/origin.yaml --img 640 640 --cfg cfg/training/yolov7.yaml --weights '' --name yolov7 --hyp data/hyp.scratch.p5.yaml
...
train_aux:
	python3 train_aux.py --workers 0 --batch-size 4 --data data/origin.yaml --img 1280 1280 --cfg cfg/training/yolov7-w6.yaml --weights '' --name yolov7-w6 --hyp data/hyp.scratch.p6.yaml
